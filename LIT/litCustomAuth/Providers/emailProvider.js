...
//import { LitRelay } from "../relay.js";
//import { customLAAuthMethod } from "../../utils/constants.js";
...
class Email {
    ...
    async prepareMintBody(data, customArgs) {
        ...
        const defaultArgs = {
            // default params
            keyType: 2,
            permittedAuthMethodTypes: [data.authMethodType, LAAuthMethod.authMethodType],
        ...
        let args = Object.assign({}, defaultArgs, customArgs);
    ...
    async getAuthMethodId(authMethod) {
        ...
        const authMethodId = ethers.utils.keccak256(ethers.utils.toUtf8Bytes(`${decodedPayload.uuid}`));
        return authMethodId;
    }
