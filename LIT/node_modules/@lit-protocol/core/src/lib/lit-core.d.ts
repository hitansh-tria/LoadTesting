...
export declare type LitNodeClientConfigWithDefaults = Required<Pick<LitNodeClientConfig, 'alertWhenUnauthorized' | 'debug' | 'connectTimeout' | 'checkNodeAttestation' | 'litNetwork' | 'minNodeCount'>> & Partial<Pick<LitNodeClientConfig, 'storageProvider' | 'contractContext' | 'rpcUrl'>> & {
...
export declare class LitCore {
     ...
     */
    computeHDPubKey: (keyId: string, sigType?: LIT_CURVE) => string;
    /**
