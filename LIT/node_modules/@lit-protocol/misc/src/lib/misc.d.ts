 ...
 */
export declare const removeHexPrefix: (str: string) => string;
/**
 ...
 */
export declare function normalizeAndStringify(input: string): string;
/**
 ...
 */
export declare function getIpAddress(domain: string): Promise<string>;
